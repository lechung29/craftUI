    ...
    return (
        <div className="flex-1 w-full max-w-3xl px-4 sm:px-6 mx-auto py-6 md:py-12 lg:py-16">
            <div className="mb-5 md:mb-8">
                <h1 className="text-lg md:text-2xl lg:text-3xl font-bold text-white mb-1">Submit Feedback</h1>
                <p className="text-white/50 text-xs md:text-sm">Help us improve by sharing your thoughts and suggestions.</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                <div className="space-y-1.5 md:space-y-2">
                    <label className="block text-xs md:text-sm font-medium text-white/90">Feedback</label>
                ...
                <div className="pt-0.5">
                    <PrimaryButton
                        ...
                        className={cx(
                            ...
                            feedback.trim() ? "bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg shadow-indigo-500/20 active:scale-95" : "bg-white/5 text-white/20 cursor-not-allowed",
                        )}
                    >
                        Submit Feedback
                    </PrimaryButton>
