...
export const DefaultButton = React.forwardRef<HTMLButtonElement, DefaultButtonProps>((props, ref) => {
    ...
    const baseClass = "flex items-center justify-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 min-h-10 rounded-lg transition-all text-sm font-medium text-white/90";
